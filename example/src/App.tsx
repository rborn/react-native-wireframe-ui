...
import {
    ...
    VBarChart,
    VBox
} from '@rborn/react-native-wireframe-ui';
...
export default function App() {
    const [fontsLoaded] = useFonts({
        WaitingfortheSunrise: require('../assets/fonts/WaitingfortheSunrise-Regular.ttf')
    });
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainerStyle}>
            ...
            <VBox>
                ...
                <Button icon fill height={10} title={'with icon no width'} color={'slate-600'} />
            ...
            <VBox>
                ...
                <VBarChart width={'2/5'} height={40} color={'green-600'} />
